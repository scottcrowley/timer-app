...
class InstallCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'timer-app:install';
    ...
    {
        $this->info('>> Welcome to the Timer App installation process! <<');
    }
    ...
    {
        $this->info('>> The installation process is complete. Enjoy your new Timer App! <<');
    }
