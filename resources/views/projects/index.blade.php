            ...
            <div class="w-1/3 px-3 pb-6">
                <div class="card flex flex-col" style="height: 14rem;">
                    ...
                    <div class="card-body flex flex-col flex-1">
                        ...
                        <p><span class="font-semibold">{{ $project->all_billable_time }}</span> billable {{ Str::plural('hour', $project->all_billable_time) }}</p>
                        <p><span class="font-semibold">{{ $project->all_non_billable_time }}</span> non-billable {{ Str::plural('hour', $project->all_non_billable_time) }}</p>
                    </div>
                </div>
            </div>
        @empty
